...
const getSingleRoom = async (req, res) => {
    ...
    const connection = req.app.get("mysqlConnection");
    const getSingleRoomQuery = "SELECT rooms.roomId, rooms.name, rooms.description, bookings.bookingId, CONVERT_TZ(bookings.start_date, '+00:00', '+00:00') as start_date, CONVERT_TZ(bookings.end_date, '+00:00', '+00:00') as end_date FROM rooms LEFT JOIN bookings ON rooms.roomId = bookings.roomFKID WHERE rooms.roomId = ?;";
